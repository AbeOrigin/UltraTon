...
- [x] **Objective:** Elevate UltraTon from secure HTTP primitive to enterprise-ready composable client.
- [x] `[8 pts]` **DNS Rebinding Prevention:** Investigate custom caching resolver to lock host IPs across the request lifecycle to neutralize split-second SSRF DNS rebinding.
